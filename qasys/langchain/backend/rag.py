...
from indexing import load_local_txt, split_docs, store_splits
from answer_merge import merge_answers
from setup_logging import setup_logging
from txt2pdf_path import txt2pdf_path, txt2pdf_path_list
...
def rag():
    ...
    result = {
        "questions": questions,
        "document_path": txt2pdf_path(folder_path),
