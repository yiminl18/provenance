...
from baseline import baseline0, baseline1, baseline2_greedy_search, baseline2_binary_search, rag_dataset_generation, baseline3_reverse_search, baseline2_greedy_refine_search
dataset_names = ['civic', 'notice', 'paper']
model_names = ['gpt4omini']
...
# for dataset_name in dataset_names:
#     baseline1(dataset_name, model_names, 0.99, "baseline1")


# for dataset_name in dataset_names:
#     baseline3_reverse_search(dataset_name, model_names, 0.99, "baseline3_reverse")
...
for _ in range(10):
    for dataset_name in dataset_names:
        ...
        baseline3_reverse_search(dataset_name, model_names, baseline_name="baseline3_reverse")


# for dataset_name in dataset_names:
#     baseline2_greedy_refine_search(dataset_name, model_names, baseline_name="baseline2_greedy_refine")
