...
#         rags(questions=questions, document_path=folder_path, evdience_finding_model_name='gpt35', dataset_name='civic')
        # rags(questions=questions, document_path=folder_path, evdience_finding_model_name='gpt4o', dataset_name='civic')
        # rags(questions=questions, document_path=folder_path, evdience_finding_model_name='gpt4omini', dataset_name='civic')
...
# for _ in range(1):
#     for folder_path in folder_paths:
#         rags(questions=questions, document_path=folder_path, evdience_finding_model_name='gpt35', dataset_name='paper')
#         rags(questions=questions, document_path=folder_path, evdience_finding_model_name='gpt4o', dataset_name='paper')
#         rags(questions=questions, document_path=folder_path, evdience_finding_model_name='gpt4omini', dataset_name='paper')
...
# for _ in range(1):
#     for folder_path in folder_paths:
#         rags(questions=questions, document_path=folder_path, evdience_finding_model_name='gpt35', dataset_name='notice')
#         rags(questions=questions, document_path=folder_path, evdience_finding_model_name='gpt4o', dataset_name='notice')
#         rags(questions=questions, document_path=folder_path, evdience_finding_model_name='gpt4omini', dataset_name='notice')
...
from baseline import baseline0, baseline1, baseline2
dataset_names = ['civic', 'notice', 'paper']
model_names = ['gpt4o']
question_sets = [civic_q(), notice_q(), paper_q()]
folder_paths = [civic_path(), notice_path(), paper_path()]
baseline_names = ['baseline0', 'baseline1_0.6', 'baseline1_0.7', 'baseline1_0.8', 'baseline2']
...
#         baseline1(dataset_name, model_name, question_set, 0.4, "baseline1_0.4")
...
for dataset_name, question_set in zip(dataset_names, question_sets):
    for model_name in model_names:
        baseline1(dataset_name, model_name, question_set, 0.7, "baseline1_0.7")
...
for dataset_name, question_set in zip(dataset_names, question_sets):
    for model_name in model_names:
        baseline2(dataset_name, model_name, question_set, baseline_name="baseline2")
